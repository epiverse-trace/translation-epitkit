...
> # ![logo Epi Training Kit](./img/LogoEpiTKit.jpg){width="150"} `Epi-Training Kit`
>
...
![data.org(./img/data.org.jpg){width="200"}

![javeriana](./img/javeriana.jpg){width="200"}

![MRC Unit The Gambia](./img/MRC.jpg){width="200"}
