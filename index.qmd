...
<img src="andes.png" alt="Universidad de los Andes" style="max-width: 150px; margin: 0 10px;">
<img src="javeriana.png" alt="Pontificia Universidad Javeriana" style="max-width: 150px; margin: 0 10px;">
```
<style> .partners { display: flex; justify-content: space-around; align-items: center; margin: 20px 0; } </style>
